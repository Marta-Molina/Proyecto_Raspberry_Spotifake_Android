...
class UserAdapter(
    ...
    override fun onBindViewHolder(holder: UserViewHolder, position: Int) {
        ...
        holder.tvAdminBadge.visibility = if (user.admin == true) View.VISIBLE else View.GONE
        
        // Hide promote button if already admin
        holder.btnPromoteAdmin.visibility = if (user.admin == true) View.GONE else View.VISIBLE
